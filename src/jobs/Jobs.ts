...
class JobsBackup extends JobOneTemplate {
  ...
  constructor(settings: Settings, admin: App, store: Storage) {
    ...
    this.firestore = async () => {
      const newJob = new JobBackupFirestore(
        this.settings,
        this.admin,
        this.store
      );
    ...
    this.storage = async () => {
      const newJob = new JobBackupStorage(
        this.settings,
        this.admin,
        this.store
      );
...
class JobsClean extends JobOneTemplate {
  ...
  constructor(settings: Settings, admin: App, store: Storage) {
    ...
    this.firestore = async () => {
      const newJob = new JobCleanFirestore(
        this.settings,
        this.admin,
        this.store
      );
...
class JobsRestore extends JobOneTemplate {
  ...
  constructor(settings: Settings, admin: App, store: Storage) {
    ...
    this.firestore = async () => {
      const newJob = new JobRestoreFirestore(
        this.settings,
        this.admin,
        this.store
      );
    ...
    this.storage = async () => {
      const newJob = new JobRestoreStorage(
        this.settings,
        this.admin,
        this.store
      );
