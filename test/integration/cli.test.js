...
describe("Integration test CLI", function () {
  ...
  /*
    ...
    */
  it(
    'node ./lib/bin/firebase-engine.js operations="backup" buckets="' +
      serviceAccount.project_id +
      '.appspot.com" collections="test" service="firestore, storage, auth" path="' +
  ...
  /*
    ...
    */
  it(
    'node ./lib/bin/firebase-engine.js operations="clean" buckets="' +
      serviceAccount.project_id +
      '.appspot.com" collections="test" service="all" path="' +
      settings.serviceAccountPath +
      '"',
    async function () {
      const log = await childProcessPromise("node", [
  ...
  /*
    ...
    */
  it(
    'node ./lib/bin/firebase-engine.js operations="restore" buckets="' +
      serviceAccount.project_id +
      '.appspot.com" collections="test" path="' +
      settings.serviceAccountPath +
      '" backup="' +
      backupPath +
      '"',
  ...
  /*
    ...
    */
  it(
    'node ./lib/bin/firebase-engine.js o="b" s="f, s, a" p="' +
      settings.serviceAccountPath +
      '" b="' +
      backupPath +
      '" -nc',
  ...
  /*
    ...
    */
  it(
    'node ./lib/bin/firebase-engine.js o="c" p="' +
      settings.serviceAccountPath +
      '"',
    async function () {
      const log = await childProcessPromise("node", [
  ...
  /*
    ...
    */
  it(
    'node ./lib/bin/firebase-engine.js o="r" p="' +
      settings.serviceAccountPath +
      '" b="' +
      backupPath +
      '" --nocompress',
